...
## @type: DataSource
## @args: [database = "dcp", table_name = "dcp_glue_landing_AWS_REGION_ACCOUNT_ID", transformation_ctx = "datasource0"]
## @return: datasource0
## @inputs: []
datasource0 = glueContext.create_dynamic_frame.from_catalog(database = "dcp", table_name = "dcp_glue_landing_AWS_REGION_ACCOUNT_ID", transformation_ctx = "datasource0")
## @type: ApplyMapping
