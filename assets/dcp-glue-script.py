...
## @type: DataSource
## @args: [database = "dcp", table_name = "dcp_glue_AWS_REGION_ACCOUNT_ID", transformation_ctx = "datasource0"]
## @return: datasource0
## @inputs: []
datasource0 = glueContext.create_dynamic_frame.from_catalog(database = "dcp", table_name = "dcp_glue_AWS_REGION_ACCOUNT_ID", transformation_ctx = "datasource0")
## @type: ApplyMapping
...
## @type: DataSink
## @args: [connection_type = "s3", connection_options = {"path": "s3://ATHENA_BUCKET"}, format = "parquet", transformation_ctx = "datasink2"]
## @return: datasink2
## @inputs: [frame = applymapping1]
datasink2 = glueContext.write_dynamic_frame.from_options(frame = applymapping1, connection_type = "s3", connection_options = {"path": "s3://ATHENA_BUCKET"}, format = "parquet", transformation_ctx = "datasink2")
job.commit()
